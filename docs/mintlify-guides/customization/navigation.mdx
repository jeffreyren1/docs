      ...
      "groups": [
        {
          ...
          "pages": ["docs/mintlify-guides/getting-started/quickstart"]
        }
      ]
    }
  ]
      ...
      "groups": [
        {
          "group": "Getting Started",
          "pages": [
            "docs/mintlify-guides/getting-started/quickstart",
            {
...
You cannot use `api` for the name of a folder unless you nest it inside another folder. Mintlify uses Next.js which reserves the top-level `api` folder for internal server calls. A folder name such as `docs/api-reference` would be accepted.
