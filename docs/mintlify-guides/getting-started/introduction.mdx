...
<Card
  title="Start here"
  icon="rocket"
  href="/docs/mintlify-guides/getting-started/quickstart"
  horizontal
>
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="palette"
    href="/docs/mintlify-guides/settings"
  >
  ...
  <Card
    ...
    icon="map"
    href="/docs/mintlify-guides/navigation"
  >
...
<Columns cols={2}>
  <Card
    ...
    icon="pen-fancy"
    href="/docs/mintlify-guides/markdown"
  >
    Use MDX to style your docs pages.
  </Card>
  <Card title="Code samples" icon="code" href="/docs/mintlify-guides/code">
    Add sample code to demonstrate how to use your product.
  </Card>
  <Card title="Images" icon="image" href="/docs/mintlify-guides/images">
    Display images and other media.
  </Card>
  <Card
    title="Reusable snippets"
    icon="recycle"
    href="/docs/mintlify-guides/reusable-snippets"
  >
